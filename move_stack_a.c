...
/*   Updated: 2024/04/04 12:50:30 by izperez          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	set_target_a(t_psl *a, t_psl *b)
{
	t_stack	*current;
...
static void	set_price(t_psl *a, t_psl *b)
{
	t_stack	*current;
...
static void	set_cheapest(t_psl *list)
{
	t_stack	*current;
